...
declare -A online_music=(
  ...
  ["YT - Anime Piano Playlist 🎹🎶"]="https://www.youtube.com/watch?v=etbtS0rTvZg"
  ["YT - Anime Song Playlist 📹🎶"]="https://www.youtube.com/watch?v=ZlbrFx6kWlI"
  ["YT - Old is Gold 📹🎶"]="https://youtu.be/Zd4y8hCNK5E?si=xUYoIOu83lArDFj3"
  ["YT - Atif Aslam 📹🎶"]="https://youtu.be/DKEXeoKb1CQ?si=TNjZm5aVGlkY8GGq"
)
...
play_online_music() {
  ...
  mpv --shuffle --vid=no --ytdl-raw-options=extractor-args="youtube:player_client=android" "$link"
}

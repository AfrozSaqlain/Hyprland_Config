...
hl.bind("xf86KbdBrightnessDown", hl.dsp.exec_cmd(HOME .. "/.config/hypr/scripts/BrightnessKbd.sh --dec"))

-- decrease keyboard brightness

hl.bind("xf86KbdBrightnessUp", hl.dsp.exec_cmd(HOME .. "/.config/hypr/scripts/BrightnessKbd.sh --inc"))
...
hl.bind(mainMod .. " + " .. "F6", hl.dsp.exec_cmd(HOME .. "/.config/hypr/scripts/ScreenShot.sh --now"))

-- screenshot

hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "F6", hl.dsp.exec_cmd(HOME .. "/.config/hypr/scripts/ScreenShot.sh --area"))

-- screenshot (area)

hl.bind(mainMod .. " + " .. "CTRL" .. " + " .. "F6", hl.dsp.exec_cmd(HOME .. "/.config/hypr/scripts/ScreenShot.sh --in5"))

-- # screenshot (5 secs delay)

hl.bind(mainMod .. " + " .. "ALT" .. " + " .. "F6", hl.dsp.exec_cmd(HOME .. "/.config/hypr/scripts/ScreenShot.sh --in10"))
